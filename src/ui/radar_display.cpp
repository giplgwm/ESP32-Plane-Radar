...
namespace gfx_fonts = lgfx::v1::fonts;
...
const lgfx::GFXfont* s_cardinal_gfx = &gfx_fonts::FreeSansBold12pt7b;
const lgfx::GFXfont* s_scale_gfx = &gfx_fonts::FreeSansBold9pt7b;
const lgfx::GFXfont* s_tag_gfx = &gfx_fonts::FreeSansBold12pt7b;
...
void initLabelMetrics() {
  ...
  if (displayFontIsSmooth()) {
    ...
    const lgfx::GFXfont* cardinal_candidates[] = {&gfx_fonts::FreeSansBold12pt7b,
                                                  &gfx_fonts::FreeSansBold9pt7b};
    s_cardinal_gfx =
    ...
    const int scale_target = cardinal_h - radar::kScaleBelowCardinalPx;
    const lgfx::GFXfont* scale_candidates[] = {&gfx_fonts::FreeSansBold9pt7b,
                                               &gfx_fonts::FreeSansBold12pt7b};
...
void initTagLabelMetrics() {
  ...
  if (displayFontIsSmooth()) {
    ...
    const lgfx::GFXfont* tag_candidates[] = {&gfx_fonts::FreeSansBold12pt7b,
                                               &gfx_fonts::FreeSansBold9pt7b};
